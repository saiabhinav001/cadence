        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur-xl">
            ...
            <CardContent>
                <form action={async () => {
                    ...
                    <Button variant="outline" type="submit" className="w-full relative gap-2 bg-white/5 border-white/10 hover:bg-white/10 hover:text-white" disabled={isPending}>
                        <svg className="h-5 w-5" viewBox="0 0 24 24">
                            ...
                            />
                            <path
                                d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.261.81-.58z"
                                fill="#FBBC05"
                            />
                            <path
